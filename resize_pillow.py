...
def main(main_images_folder, new_width=800):
    ...
    for root, dirs, files in os.walk(main_images_folder):
        for file in files:
            ...
            # if converted_tag in file_full_path:               #remove os arquivos já convertidos
            ...
            # os.remove(file_full_path)             #exclui os arquivos originais


if __name__ == '__main__':
    main_images_folder = 'CAMINHO DA PASTA COM OS ARQUIVOS'
